...
- `Docks/Shopee/Guia Mestre de Operação Shopee Brasil 2026.md`
- `Docks/Shopee/Guia Avançado_ Algoritmo e Visibilidade (SEO & Marketing) Shopee 2026.md`
- `Docks/Shopee/Guia Avançado_ Shopee Ads 2026.md`
...
2. Taxas totais (Comissão da Shopee + Impostos). 
  - **Regra Atualizada Shopee (Padrão Geral):** A comissão padrão é de **20%** (18% comissão líquida + 2% transação) + **R$ 4,00 de Taxa Fixa por item**. 
  - *(Nota: O acréscimo de R$ 3,00 para contas CPF só se aplica a vendedores de baixo volume. Para o nosso cálculo padrão, desconsidere essa taxa punitiva, focando no custo real de 20% + R$ 4,00).*
...
## 4. Salvamento Duplo (Notion e Diretório Físico)
Sempre que eu solicitar a criação ou otimização de descrições, títulos e palavras-chave de produtos para a Shopee, você **DEVE realizar duas ações obrigatórias**:

**Ação 1: Salvar no Notion**
- **Pasta Destino (Parent ID):** `34bdd44d-92db-81ab-b686-c7d267634df4` (Página Shopee).
- Utilize a ferramenta do MCP para criar uma subpágina. A página DEVE conter sempre esta estrutura exata: primeiro os **Títulos Sugeridos** (para SEO) no topo do arquivo, e logo abaixo a **Descrição Sugerida** completa.

**Ação 2: Salvar Localmente (.md)**
- **Pasta Destino:** `C:\Users\lukas\OneDrive\Pictures\loja_shoppe\loja 1\produtos\reparador_pontas\descriçoes`
- Crie um arquivo markdown (`.md`) com o nome do produto dentro desta pasta.
- O conteúdo do arquivo deve ser rigorosamente o mesmo gerado para o Notion (Títulos + Descrição), garantindo que tenhamos um backup físico e local de toda a criação.
